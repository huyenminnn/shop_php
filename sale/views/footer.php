			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Any questions? Let us know in store at No.600, Giai Phong Street or call us on (+84) 96 326 470
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This page is made <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.facebook.com/quynh.lam.7739" target="_blank">Minh Huyen</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
