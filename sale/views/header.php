		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<h3 style="margin-right: 30px;"><a href="?mod=home" class="text-dark">MINSHOP</a></h3>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="?mod=cart&act=show">Your cart</a>
							</li>

							<li>
								<a href="https://www.facebook.com/quynh.lam.7739">Fanpage</a>
							</li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?= $num ?>">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					<div class="header-cart-total w-full p-tb-40">
						<h3>Total: <b style="color: red;"><?= number_format($total) ?></b> VND</h3> 
					</div>
				
					<div class="header-cart-buttons flex-w w-full">
						<a href="?mod=cart&act=show" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart
						</a>
