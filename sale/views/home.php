	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="?mod=cart&act=addToCart1&code=<?=$product['code']?>" class="btn"><i class="fas fa-cart-arrow-down"></i></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<a href="?mod=allProduct" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
					Load More
				</a>
			</div>
		</div>
